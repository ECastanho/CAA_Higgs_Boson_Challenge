...
classifier = AdaBoostClassifier(DecisionTreeClassifier(max_depth=30),n_estimators=300,algorithm='SAMME')
...
np.savetxt("./Submission_Files/submission_BDTs.csv",submission,fmt='%s',delimiter=',')
